...
- Take the Sanity Learn course: [Build content apps with Sanity App SDK](https://www.sanity.io/learn/course/build-content-apps-with-sanity-app-sdk).
- Watch the walkthrough presentation from Everything NYC: [Building Custom Content Apps with App SDK](https://youtu.be/UBSDmRmdNS8).
